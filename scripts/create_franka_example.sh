echo "Creating Franka Camera example"
...
<mujoco model="panda scene">
  ...
  <worldbody>
    <camera name="front" pos="1.4 0 0.6" fovy="58" mode="fixed" euler="0 1.2 1.5708"/>
  ...
  <keyframe>
    <key name="home"
      qpos="0 0.3 0 -1.57079 0 1.96 0.785 0.04 0.04 0.7 0 0.03 1 0 0 0"
      ctrl="0 0.3 0 -1.57079 0 1.96 0.785 0.04"/>
    <key name="pickup"
...
mv mjx_single_cube_camera.xml external/mujoco_menagerie/franka_emika_panda/mjx_single_cube_camera.xml